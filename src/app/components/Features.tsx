      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-slate-100 hover:border-[#2C8ED6]/30 bg-white flex flex-col">
              <CardContent className="p-8 flex flex-col h-full justify-between">
                ...
                <Link 
                  to={feature.path} 
                  className="inline-flex items-center gap-1.5 text-sm font-extrabold text-[#0B5FA5] hover:text-[#2C8ED6] transition-colors group/link mt-auto outline-none"
                >
                  Access Service ⚡️
